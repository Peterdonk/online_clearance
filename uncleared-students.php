...
<html lang="en">
    ...
    <head>
        <meta charset="utf-8" />
        <title>Uncleared Student List | Online Clearance</title>
...
while($eachStudent= mysqli_fetch_array($getStudents)){  
    ...
    $check_clearers = mysqli_query($connectionString,"SELECT * FROM clearing_agents WHERE agent_department = '$get_student_department_raw'")or die(mysqli_error($connectionString));
