...
for ($i=0; $i < $count_departments; $i++) {
    ...
    $insert_query = mysqli_query($connectionString,"INSERT INTO `clearing_agents` (`agent_id`, `agent_secret_id`, `agent_department`, `agent_name`, `agent_contact`, `agent_address`,`agent_role`, `agent_timestamp`) VALUES (NULL, '$generated_number', '$current_selected_department', '$get_name', '$get_contact', '$get_address','$get_agent_role', current_timestamp())")or die(mysqli_error($connectionString));
}
