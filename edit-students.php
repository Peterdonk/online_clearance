...
<div class="modal-body">
 <form class="needs-validation mt-4" novalidate id="edit-student" method="POST">
    <input type="hidden" name="student_hidden" value="" id="student_hidden">
                                            <div class="row">
...
alertify.set('notifier','position', 'top-right');
            ...
            $('#edit-student').submit(function(e){
                 ...
                 $.ajax({
                url:'api_calls/update-student-details.php',
                type: 'POST',
                data: formdata,
            ...
            $(document).on('click','.btn-edit',function(e){
                ...
                $('#student_hidden').val(id);

                  $.ajax({
                url:'api_calls/get-student-details.php',
                type: 'POST',
                data: {id:id},
                success:function(res){
            ...
            $(document).on('click','.btn-delete',function(e){
                var id = $(this).attr('id');
                alertify.confirm("Are You Sure Want To Delete This Student",
                  function(){
                    $.ajax({
                url:'api_calls/delete-student.php',
                type: 'POST',
                data: {id:id},
                success:function(res){
